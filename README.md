...
A modern, sleek, Windows 11 Fluent-inspired desktop and web notepad built with React, TypeScript, Tailwind CSS, Vite, and Electron.
...
1. **Fork the Repository**:
   Click the **Fork** button at the top right of the [notepadEZ GitHub repository](https://github.com/reinieltalplacido/notepadEZ).
...
- **Pure Rich Text & WYSIWYG Editor**: Write naturally with direct visual formatting (Bold, Italic, Headings, Bullet & Numbered Lists, Code Blocks, Blockquotes, Tables, Checklists). No raw markdown syntax tags cluttering your screen.
...
- **Pure Edge-to-Edge Full Screen Mode**: Distraction-free writing canvas toggled via `F11` or `Ctrl+Shift+F` with zero header clutter.
...
- **In-App Patch Notes & Auto-Updater**: Check release history and get automatic update notifications directly inside the application.
